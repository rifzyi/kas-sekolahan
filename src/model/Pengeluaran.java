...
public class Pengeluaran {
  ...
  public Pengeluaran(int idPengeluaran, LocalDate tanggal, int idKategoriPengeluaran, String kategori, double nominal, String keterangan) {
    this.idPengeluaran = idPengeluaran; this.tanggal = tanggal; this.idKategoriPengeluaran = idKategoriPengeluaran; this.kategori = kategori; this.nominal = nominal; this.keterangan = keterangan;
  }
